...
def build_loader(config):
    ...
    print(f"Successfully built val dataset")
    ...
    data_loader_train = torch.utils.data.DataLoader(
        ...
        pin_memory=config.DATA.PIN_MEMORY if torch.cuda.is_available() else False,  # CPU环境关闭pin_memory
        drop_last=True,
    )
...
def build_dataset(is_train, config):
    ...
    if config.DATA.DATASET == 'imagenet':
        ...
        raise NotImplementedError("We only support ImageNet, CIFAR10, CIFAR100, tiny-imagenet, imagenet22K now.")
